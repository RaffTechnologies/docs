...
`--static` embeds a token in the file instead, for environments that cannot run the CLI. It expires (7 days by default, `--ttl` to change) and must be re-issued afterwards.
