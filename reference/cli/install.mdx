...
Replace `0.5.0` below with the version you want from the [Releases page](https://github.com/RaffTechnologies/raff-cli/releases).

```bash
# Linux x86_64
curl -sL https://github.com/RaffTechnologies/raff-cli/releases/download/v0.5.0/raff_0.5.0_linux_x86_64.tar.gz | tar -xzv
sudo mv raff /usr/local/bin/

# macOS arm64 (Apple Silicon)
curl -sL https://github.com/RaffTechnologies/raff-cli/releases/download/v0.5.0/raff_0.5.0_macos_arm64.tar.gz | tar -xzv
sudo mv raff /usr/local/bin/
```
