...
<CardGroup cols={3}>
  <Card title="Virtual Machines" icon="server" color="#F97316" href="/products/build/virtual-machines">
    **Ready** · Linux & Windows VMs, NVMe SSD, snapshots, backups, SSH/RDP. Plans from \$4.99/mo.
  </Card>
  <Card title="Kubernetes" icon="dharmachakra" color="#F97316" href="/products/build/kubernetes">
    **Ready** · Managed K8s clusters — free control plane, autoscaling node pools, one-click apps. Nodes from \$9.99/mo.
  </Card>
