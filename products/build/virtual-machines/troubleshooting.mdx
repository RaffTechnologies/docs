...
<AccordionGroup>
  ...
  <Accordion title="VM stuck in `provisioning` while running fine">
    ...
    **Fix:** Wait — typically 1-5 minutes. See [Lifecycle states](/products/build/virtual-machines/concepts/lifecycle-states#provisioning-during-snapshots-and-backups).
  </Accordion>
