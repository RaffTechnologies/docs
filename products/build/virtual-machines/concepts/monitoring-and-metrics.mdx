...
<Frame>
  ![VM detail page on the Graphs tab with the VM Information side panel and time-range selector](/images/products/compute/vm/concepts/monitoring-01-graphs-overview.png)
</Frame>
...
<Frame>
  ![Memory Usage graph showing Used (red) and Free (green) MB stacked over time, with a sharp drop indicating an OOM event or restart](/images/products/compute/vm/concepts/monitoring-02-memory.png)
</Frame>
...
<Frame>
  ![Network Traffic graph with RX and TX series for two interfaces over time](/images/products/compute/vm/concepts/monitoring-03-network.png)
</Frame>
...
<Frame>
  ![Disk Throughput graph with Read and Write KB/s over time, showing a single read spike during a one-off load](/images/products/compute/vm/concepts/monitoring-04-disk.png)
</Frame>
