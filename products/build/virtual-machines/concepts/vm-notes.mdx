...
<Frame>
  ![Actions tab on a VM detail page showing My Notes and Team Notes fields, with hint text "only you can see this" and "visible to all members"](/images/products/build/vm/concepts/vm-notes-01-actions-tab.png)
</Frame>
