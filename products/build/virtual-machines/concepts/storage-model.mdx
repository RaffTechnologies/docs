...
The boot disk that comes with every VM. Sized by the plan you pick (e.g. 50 GB on the \$8.99/mo plan). Holds the OS, installed software, and anything you didn't put on a volume.
...
- Above the pool: \$0.06/GB/month on the combined excess only.
