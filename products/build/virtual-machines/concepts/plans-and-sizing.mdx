---
title: Plans & sizing
description: Three plan tiers (General Purpose / shared CPU, CPU Optimized / guaranteed CPU, and Windows Server), how to pick between them, and which size to start with for common workloads — web apps, databases, workers, dev/staging, Windows desktop, game servers
---
...
| **Windows Server** | **Guaranteed** vCPU | Anything running Windows. Its own plan family, chosen by picking a Windows template; the licence is a separate line |

In simple terms:

- **Standard** — the platform may share the underlying physical core with other VMs. Performance is great most of the time but can have brief jitter when neighbors get busy. Best price/CPU. Standard is **burstable**: all your vCPUs are available whenever you need them, on top of a sustained level you can hold indefinitely — see [CPU and bursting](/products/build/virtual-machines/concepts/cpu-and-bursting).
