...
Pick **Standard** for cost-efficient general-purpose workloads where short performance dips don't matter. Pick **Premium** when consistent, guaranteed CPU is the goal — half a physical thread is reserved for every vCPU, with burst to the full thread.
