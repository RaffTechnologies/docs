...
<Frame>
  ![Browser terminal showing a logged-in Linux shell with the VM's hostname prompt](/images/products/compute/vm/connect/connect-via-ssh-03-browser-terminal.png)
</Frame>
...
<Frame>
  ![Windows VNC console session in the browser showing the Windows login screen](/images/products/compute/vm/connect/connect-via-rdp-01-vnc-console.png)
</Frame>
...
<Frame>
  ![Compute → row Actions menu open with View Details, Copy IP, Open Terminal, Rename, Stop, Restart, Reinstall OS, Destroy](/images/products/compute/vm/connect/connect-via-ssh-01-actions-menu.png)
</Frame>

<Frame>
  ![VM detail page with the orange Console action button at the top of the action bar](/images/products/compute/vm/connect/connect-via-ssh-02-vm-detail-console.png)
</Frame>
