...
<Frame>
  ![VM detail page Backups tab with Instant Backup and Schedule Backup buttons](/images/products/compute/vm/snapshots-backups/enable-backups-01-vm-detail-tab.png)
</Frame>
...
<Frame>
  ![Compute Resources Backups tab with VM Backups sub-tab showing the Finance VM and 1 free backup](/images/products/compute/vm/snapshots-backups/enable-backups-04-account-vm-backups.png)
</Frame>
...
<Frame>
  ![Scheduled Backups sub-tab with the row Actions menu showing Update Schedule, Update Retention, and Delete](/images/products/compute/vm/snapshots-backups/enable-backups-05-account-schedules.png)
</Frame>
...
<Frame>
  ![Create Instant Backup dialog with Virtual Machine and Backup Name fields and an About panel](/images/products/compute/vm/snapshots-backups/enable-backups-03-instant-dialog.png)
</Frame>
...
<Frame>
  ![Schedule Backup dialog with Virtual Machine, Backup Name, Frequency (Daily), Time Window, and Retention (Days) fields](/images/products/compute/vm/snapshots-backups/enable-backups-02-schedule-dialog.png)
</Frame>
