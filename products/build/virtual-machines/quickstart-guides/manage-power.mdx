...
<Frame>
  ![VM detail page on the Power tab, with the Running toggle top right and the Turn Off VM button](/images/products/build/vm/manage/manage-power-01-power-tab.png)
</Frame>
...
<Frame>
  ![Instance list with the row Actions menu open showing Stop and Restart options](/images/products/build/vm/connect/connect-via-ssh-01-actions-menu.png)
</Frame>
