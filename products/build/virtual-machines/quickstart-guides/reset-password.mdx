...
<Frame>
  ![VM detail page on the Actions tab showing Access & Security with Open Terminal and Reset Password cards](/images/products/build/virtual-machines/reset-password-01-actions-tab.png)
</Frame>
