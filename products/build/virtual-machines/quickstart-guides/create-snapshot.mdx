...
<Frame>
  ![Compute Resources Snapshots tab showing the empty state and Create Snapshot button](/images/products/compute/vm/snapshots-backups/create-snapshot-01-snapshots-tab.png)
</Frame>

The dialog asks you to pick what kind and which resource:

<Frame>
  ![General Create Snapshot dialog with Type, Resource, and Name fields](/images/products/compute/vm/snapshots-backups/create-snapshot-02-dialog-general.png)
</Frame>
...
<Frame>
  ![VM detail page Snapshots tab with the Create Snapshot button on the right](/images/products/compute/vm/snapshots-backups/create-snapshot-03-vm-detail-snapshots-tab.png)
</Frame>
...
<Frame>
  ![VM-scoped Create Snapshot dialog pre-filled with the current VM and auto-generated name](/images/products/compute/vm/snapshots-backups/create-snapshot-04-dialog-vm-scoped.png)
</Frame>
