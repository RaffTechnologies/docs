...
<Frame>
  ![VM detail page with the pencil edit icon next to the VM name](/images/products/build/vm/manage/rename-01-pencil-icon.png)
</Frame>
...
<Frame>
  ![Instance list row Actions menu showing the Rename option](/images/products/build/vm/connect/connect-via-ssh-01-actions-menu.png)
</Frame>
...
<Frame>
  ![Rename VM dialog with the Name field and a 64-character counter](/images/products/build/vm/manage/rename-02-dialog.png)
</Frame>
