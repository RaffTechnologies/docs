...
<Frame>
  ![Region picker on the new-VM page](/images/products/build/vm/create/create-a-vm-01-region-and-os.png)
</Frame>
...
<Frame>
  ![OS Template grid with the Version picker showing 3 versions available](/images/products/build/vm/create/create-a-vm-02-os-template.png)
</Frame>
...
<Frame>
  ![Choose Size: Monthly/Yearly/2-Year tabs, General Purpose vs CPU-Optimized, plan grid](/images/products/build/vm/create/create-a-vm-03-choose-size.png)
</Frame>
...
<Frame>
  ![Networking section: private network, public IPv4, IPv6 — and Authentication block below](/images/products/build/vm/create/create-a-vm-04-networking-and-auth.png)
</Frame>
...
<Frame>
  ![Additional Storage section: 50/100/150 GiB presets and custom slider, Backup section preview](/images/products/build/vm/create/create-a-vm-05-storage-and-backup.png)
</Frame>
...
<Frame>
  ![Backup plan: Daily or Weekly, with billing rules and free tier](/images/products/build/vm/create/create-a-vm-06-backup-plan.png)
</Frame>
...
<Frame>
  ![VM Quantity, Tags, and Hostnames section](/images/products/build/vm/create/create-a-vm-07-quantity-and-tags.png)
</Frame>
...
<Frame>
  ![Checkout page: payment method on left, order summary on right](/images/products/build/vm/create/create-a-vm-08-checkout.png)
</Frame>
