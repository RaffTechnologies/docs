...
<Frame>
  ![VM detail page with the Console action button at the top](/images/products/compute/vm/connect/connect-via-ssh-02-vm-detail-console.png)
</Frame>
...
<Frame>
  ![Instance list with the row Actions menu open showing Open Terminal](/images/products/compute/vm/connect/connect-via-ssh-01-actions-menu.png)
</Frame>
...
<Frame>
  ![Browser-based SSH terminal connected to a VM with a root shell](/images/products/compute/vm/connect/connect-via-ssh-03-browser-terminal.png)
</Frame>
