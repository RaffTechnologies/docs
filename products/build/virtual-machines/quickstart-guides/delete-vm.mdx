...
<Frame>
  ![VM detail page Destroy tab with the permanent-action warning and the red Destroy VM button](/images/products/compute/vm/delete/delete-vm-01-destroy-tab.png)
</Frame>
...
<Frame>
  ![Instance list row Actions menu showing Destroy in red at the bottom](/images/products/compute/vm/connect/connect-via-ssh-01-actions-menu.png)
</Frame>
...
<Frame>
  ![Instance list with two VMs checked and the bulk toolbar showing Stop 2 and Delete Selected](/images/products/compute/vm/manage/manage-power-02-bulk-select.png)
</Frame>
...
<Frame>
  ![Destroy VM dialog with the VM name field, a confirmation text input, and a Subscription Billing notice that remaining days return to your account balance](/images/products/compute/vm/delete/delete-vm-02-confirm-name.png)
</Frame>
...
<Frame>
  ![Final Confirmation dialog showing what will be deleted, attached volumes block, attached VPCs block with Keep VPCs and Delete VPCs (recommended) options, and a red Destroy VM button](/images/products/compute/vm/delete/delete-vm-03-final-confirmation.png)
</Frame>
