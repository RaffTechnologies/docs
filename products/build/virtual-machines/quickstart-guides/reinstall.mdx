...
<Frame>
  ![Actions tab on VM detail page with the OS Reinstallation card and Change OS button](/images/products/compute/vm/manage/reinstall-01-actions-tab.png)
</Frame>
...
<Frame>
  ![Row Actions menu showing Reinstall OS option](/images/products/compute/vm/connect/connect-via-ssh-01-actions-menu.png)
</Frame>
...
<Frame>
  ![Reinstall Step 1: OS grid with Ubuntu, Fedora, Debian, CentOS, AlmaLinux, Rocky Linux, FreeBSD, Alpine Linux, openSUSE, and a Version dropdown](/images/products/compute/vm/manage/reinstall-02-select-os.png)
</Frame>
...
<Frame>
  ![Reinstall Step 2: three authentication options — SSH Key, Set Password, Email Me Password](/images/products/compute/vm/manage/reinstall-03-authentication.png)
</Frame>
...
<Frame>
  ![Reinstall Step 3: confirmation listing preserved/reset items and the 1-5 minute unavailability warning](/images/products/compute/vm/manage/reinstall-04-confirm.png)
</Frame>
