...
<Steps>
  ...
  <Step title="Choose the control plane">
    ...
    <Frame>
      ![Control plane step with single master and high availability options](/images/products/build/kubernetes/create-ha.png)
    </Frame>
  </Step>
  <Step title="Configure node pools">
    ...
    <Frame>
      ![Node pools step with worker plans, node count, autoscale, labels and taints](/images/products/build/kubernetes/create-pools.png)
    </Frame>
  </Step>
  <Step title="Pick add-ons">
    ...
    <Frame>
      ![Add-ons step with Cilium, persistent storage sizing, Traefik and MetalLB](/images/products/build/kubernetes/create-addons.png)
    </Frame>
  </Step>
  <Step title="Choose the network and firewall">
    ...
    <Frame>
      ![Network step with VPC selection and managed firewall](/images/products/build/kubernetes/create-network.png)
    </Frame>
  </Step>
  <Step title="Review and create">
    The summary shows every choice and the exact monthly price before you confirm.
    <Frame>
      ![Review step with configuration summary and monthly cost](/images/products/build/kubernetes/create-review.png)
    </Frame>
  </Step>
</Steps>
