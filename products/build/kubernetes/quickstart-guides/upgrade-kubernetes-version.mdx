...
<Steps>
  ...
  <Step title="Choose a version and upgrade">
    ...
    <Frame>
      ![TODO: Kubernetes version card in Settings — current version, target select, and automatic-upgrade mode](/images/products/build/kubernetes/version-card.png)
    </Frame>
  </Step>
  <Step title="Watch the progress">
    ...
    <Frame>
      ![TODO: Cluster header with the Upgrading badge and Activity feed showing per-node upgrade progress](/images/products/build/kubernetes/upgrade-progress.png)
    </Frame>
  </Step>
</Steps>
