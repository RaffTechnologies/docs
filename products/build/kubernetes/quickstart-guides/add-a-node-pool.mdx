...
description: Add a pool of worker nodes with its own plan, labels and taints
---

<sub>Updated August 24, 2026</sub>

Node pools group workers that share a size, labels and taints. Use separate pools for mixed workloads — e.g. a general pool plus a high-memory pool for databases.
