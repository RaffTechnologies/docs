...
Every credential we issue expires. Rotating access invalidates all of them at once — see [Cluster access and credentials](/products/build/kubernetes/concepts/cluster-access).
