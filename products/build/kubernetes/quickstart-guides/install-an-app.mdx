...
<Frame>
  ![App Hub catalog with one-click Helm charts and an installed Grafana release](/images/products/compute/kubernetes/app-hub.png)
</Frame>

The install dialog has three fields:

<Frame>
  ![Install dialog with release name, namespace and values fields](/images/products/compute/kubernetes/app-install-dialog.png)
</Frame>
...
<Note>
Apps marked **Needs persistent storage** (databases, NextCloud, …) store their data on [persistent volumes](/products/build/kubernetes/concepts/storage) — included on every cluster, billed per GB.
</Note>
...
<Frame>
  ![Installed app row with Expose, Upgrade and Uninstall actions](/images/products/compute/kubernetes/app-installed-actions.png)
</Frame>
