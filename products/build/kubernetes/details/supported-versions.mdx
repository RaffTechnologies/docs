...
Within a minor version we offer one specific patch release (for example v1.34.9). When a newer patch is validated, it replaces the older one as the upgrade target for that line.
