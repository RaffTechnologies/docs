...
The control plane — API server, scheduler, controllers, etcd — is run by Raff. The single-master control plane is **free**; the HA control plane (3 masters) costs a flat **\$30/month**. Workers and persistent volumes are billed separately.
