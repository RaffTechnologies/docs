...
description: What a Raff Kubernetes cluster is made of — gateway, control plane, workers, volume storage
---
...
| **Workers** | 1–20 per pool | Your capacity — grouped into [node pools](/products/build/kubernetes/concepts/node-pools-and-autoscaling), each pool on its own plan, billed per node |
| **Volume storage** | — | No storage nodes: PersistentVolumeClaims are provisioned as Raff Volumes and attached to workers on demand — see [Storage](/products/build/kubernetes/concepts/storage) |
