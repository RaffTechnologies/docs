...
| Line | Amount |
| --- | --- |
| Kubernetes node pool "default-pool" — K8s Standard × 2 | \$27.98 |
| Kubernetes node pool "pool-2" — K8s Performance × 1 | \$30.99 |
...
| Persistent volumes (PVCs) | \$0.08/GB/month, billed hourly for exactly the GB claimed — on both billing modes, never part of the subscription |
