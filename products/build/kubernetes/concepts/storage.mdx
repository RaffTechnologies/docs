...
- **Pay for exactly what you claim** — \$0.10/GB/month, billed hourly, and every GB you pay for is a GB you can use. Storage is never part of the cluster price; it starts billing when a PVC is created and stops when it's deleted.
