...
- Everything else is blocked by the **firewall**: the platform baseline already permits exactly 80, 443 and 6443 with nothing to configure. If you attach one of your own security groups instead, make sure it allows those three ports.
