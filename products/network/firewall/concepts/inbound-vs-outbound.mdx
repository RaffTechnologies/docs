...
Internet
    ...
    ▼
┌─────────────────────────────────────────┐
│  Layer 1: Raff Default Firewall (system)│  Blocks 7 known-dangerous ports
│  Always on. You can't disable it.       │  Lets everything else through
└─────────────────────────────────────────┘
    │
    ▼
┌─────────────────────────────────────────┐
│  Layer 2: Your Firewall Groups (custom) │  Optional. 0 or more attached per IP
│  Add, edit, detach as you like.         │  Each group has inbound + outbound rules
└─────────────────────────────────────────┘
    │
    ▼
VM (public NIC)
