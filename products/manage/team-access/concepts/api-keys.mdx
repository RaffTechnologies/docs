...
```
┌────────────────────────────────────────────────────────────────────┐
│  API Key — name + raff_<suffix>                                    │
│                                                                     │
│  Account Role: ───────────────────► Account permissions (account.*)│
│                                                                     │
│  Projects + Project Role: ────────► Project permissions on these   │
...
```
┌────────────────────────────────────────────┐
│  Create API Key dialog → Create Key click  │
│             ↓                               │
│  API Key Created dialog                    │
│  ─ Full key value visible (one time only)  │
│  ─ Copy to your secret store               │
│  ─ Click Done                              │
│             ↓                               │
│  API Keys list                             │
│  ─ Only the prefix is visible              │
│  ─ Full value cannot be retrieved          │
└────────────────────────────────────────────┘
```
