---
title: Overview
description: Team & Access on Raff — invite members, organize resources into projects, scope access at the account or per-project level, and assign roles
icon: users
---

<sub>Updated May 5, 2026</sub>

**Team & Access** is where you decide who has access to what on your Raff account. It has three pieces, each on its own tab:
...
<Frame>
  ![Team & Access page Members tab showing two members — serdar@... with Owner badge and "All projects", batuhan@... with Project-only badge and "1 project" — and an Invite Member button](/images/products/manage/team-access/team-access-members.png)
</Frame>
...
<Frame>
  ![Team & Access Projects tab showing two projects — Default (with Default badge, 0 members, created 1/22/2026) and customer1 (1 member, created 3/23/2026) — and a + Create Project button](/images/products/manage/team-access/team-access-projects.png)
</Frame>
...
<Frame>
  ![Project switcher dropdown opened from the top bar showing Raff Technologies header with Default (checked) and customer1 listed below](/images/products/manage/team-access/project-switcher.png)
</Frame>
...
API keys are managed in a separate left-sidebar item, **API Keys**, not on the Team & Access page. They're tied to your account and inherit the scope you give them at creation.
...
<CardGroup cols={2}>
  ...
  <Card title="Create a project" icon="folder-plus" href="/products/manage/team-access/quickstart-guides/create-a-project">
...
<CardGroup cols={3}>
  <Card title="Quickstart & guides" icon="rocket" href="/products/manage/team-access/quickstart-guides/invite-member">
    Members, roles, API keys.
  </Card>
  <Card title="Concepts" icon="lightbulb" href="/products/manage/team-access/concepts/roles-and-api-keys">
    Account vs project scope, roles, API key scope.
  </Card>
  <Card title="Details" icon="circle-info" href="/products/manage/team-access/details/permissions-matrix">
    Permission matrix and limits.
  </Card>
  <Card title="Troubleshooting" icon="life-ring" href="/products/manage/team-access/troubleshooting">
