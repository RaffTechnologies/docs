...
Names must be unique inside your account. Names **can be renamed later** via the row's `⋮` → **Edit Project** — see [Edit or delete a project](/products/manage/team-access/quickstart-guides/delete-a-project) for the rename flow.
...
- You can **add members** to it from `Team & Access → Members → row's expansion → + Add to Project`, or by inviting a new member with the **Project** access level scoped to this project
...
<CardGroup cols={3}>
  <Card title="Edit or delete a project" icon="pen-to-square" href="/products/manage/team-access/quickstart-guides/delete-a-project">
  ...
  <Card title="Projects and scoping" icon="lightbulb" href="/products/manage/team-access/concepts/projects-and-scoping">
