...
If you want to remove the member from the account entirely (instead of just adjusting one of their grants), see [Remove a member](/products/manage/team-access/quickstart-guides/remove-member). The actions on this page are the granular per-grant ones.

## Open the member's row

In **Team & Access → Members**, find the member and click the chevron on the left of their row to expand. The expanded row shows two sections — **Account Access** and **Project Access** — each independently manageable.
...
If the member has no account role, the section shows the **Add to Account** button instead. Clicking it grants an account role with no email — same flow as the post-invite expansion in [Invite a member](/products/manage/team-access/quickstart-guides/invite-member#after-they-accept--adding-more-access).
...
<CardGroup cols={3}>
  ...
  <Card title="Remove a member" icon="user-minus" href="/products/manage/team-access/quickstart-guides/remove-member">
