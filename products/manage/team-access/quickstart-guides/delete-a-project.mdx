...
In **Team & Access → Projects**, find the project and click the `⋮` on the right of its row.

<Frame>
  ![Projects tab with the row context menu opened on the customer1 project, showing Edit Project (pencil icon) and Delete (red, trash icon)](/images/products/manage/team-access/project-row-menu.png)
</Frame>
